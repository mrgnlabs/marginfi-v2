...
impl LiquidInsuranceFundAccountFixture {
    ...
    pub async fn try_user_deposit_insurance(
        ...
        let ix = Instruction {
            program_id: marginfi::id(),
            accounts: marginfi::accounts::DepositIntoLiquidInsuranceFund {
                ...
                user_insurance_fund_account: LiquidInsuranceFundAccount::address(
                    &self.user.pubkey(),
                ),
            }
            .to_account_metas(Some(true)),
    ...
    pub async fn try_user_withdraw_insurance_claim(
        ...
        let ix = Instruction {
            program_id: marginfi::id(),
            accounts: marginfi::accounts::SettleWithdrawClaimInLiquidInsuranceFund {
                user_insurance_fund_account: self.key,
                signer_token_account: dest_token_account.key,
                bank_insurance_vault: bank.get_vault(BankVaultType::Insurance).0,
                bank_insurance_vault_authority: bank
