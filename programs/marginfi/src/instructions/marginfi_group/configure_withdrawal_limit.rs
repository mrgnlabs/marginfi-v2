...
pub fn configure_withdrawal_limit(
    ...
    msg!(
        ...
        marginfi_group.withdraw_window_cache.daily_limit
    );

    let clock = Clock::get()?;
    marginfi_group.withdraw_window_cache.daily_limit = daily_withdrawal_limit;
    marginfi_group
...
#[derive(Accounts)]
pub struct ConfigureWithdrawalLimit<'info> {
