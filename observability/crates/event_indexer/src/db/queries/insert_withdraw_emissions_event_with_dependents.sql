...
VALUES ($1, $2, $3, $4, $5, $6, $7, (SELECT id FROM combined_account), (SELECT id FROM combined_authority), (SELECT id FROM combined_bank), (SELECT id FROM combined_emission_mint), $17)
RETURNING id;
