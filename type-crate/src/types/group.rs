...
pub struct MarginfiGroup {
    ...
    ///
    /// Subsequent to the release of the `bank_admin`, this role can be considered the "fast" admin,
    /// it can peform various tasks that do not require timelock sensitivity. High-risk activities
    /// like changing oracles or bank weights are now under the control of the "slow" bank_admin.
    pub admin: Pubkey,
